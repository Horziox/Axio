...
module.exports = {
    ...
    execute(message, args, bot, prefix) {
        ...
        .addField("Premières", "[Premières Mars 2020](https://drive.google.com/open?id=1T-NF2Tr6Jd7rpwxmkLP5NMCvc-MvrcFY)", true)
        .addField("Terminales", "[Courriers Divers](https://drive.google.com/open?id=1rNj8uNBAhPDVeuaL10mzTlNSO1Uckfk6)\n[TS2 et TS3 Mars 2020](https://drive.google.com/open?id=1tFiaWxWvcbPyFC3h8z9VXnfZIbr2qJOo)", true)
        .setColor("#FFFFF")
